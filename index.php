...
if(isset($_POST['login'])){
	...
	$result = mysqli_query($connect, 'SELECT `name`, `password`, `level` FROM `user` WHERE `name`="'.$username.'" ');
		...
		<div class="dropdown-menu dropdown-login animated fadeInUp">
			<form method="post">
				...
				<div class="form-group">
					...
					<button type="Submit" id="login" name="login" class="btn btn-primary pull-right">Submit</button>
				</div>
			</form>
